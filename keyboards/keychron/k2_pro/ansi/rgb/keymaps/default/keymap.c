...
[MAC_FN] = LAYOUT_ansi_84(
     ...
     UG_TOGG,  UG_NEXT,  KC_UP,    UG_HUEU,  UG_SATU,  UG_SPDU,  UG_VALU,  UG_VALD,  UG_PREV,  UG_HUED,  _______,  _______,  _______,  _______,            _______,
     _______,  KC_LEFT,  KC_DOWN,  KC_RGHT,  UG_SATD,  UG_SPDD,  _______,  KC_LEFT,  KC_DOWN,  KC_RGHT,  _______,  _______,            _______,            _______,
